function [Vf,Vb] = rates_blm_cara(t,Y,epsilon,boundary_data)
...
stokeslets_b    = get_reg_stokeslets(b_data,Y,epsilon);             % collocation with boundary
...
% Calculates the Oseen tensor using the method of regularised stokeslets for a given list of nodes, collocation points and regularisation parameter.
